                ...
                <form action="process/process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-4 d-flex align-items-center">
                        ...
                        <div class="password w-100">
                            <input type="password" autocomplete="off" value="<?php echo $_SESSION['old_values']['password'] ?? ''; ?>" required class="form-control" name="password" id="Password" required>
                            <i class="fa-solid eye_pass fa-eye-slash" onclick="togglePassword(false)"></i>
                        </div>
                    </div>
